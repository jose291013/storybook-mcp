...
ALTER TABLE narrative_artifacts
  ...
  CHECK (artifact_type IN (
    ...
    'object_lifecycle_projection',
    'narrative_book_spec',
    'narrative_book_spec_v3',
    'manuscript',
    'visual_storyboard'
  ));
...
ALTER TABLE narrative_v3_steps
  ...
  CHECK (step_type IN (
    'parse_story_concept',
    'compile_story_graph',
    'compile_object_lifecycle',
    'release_narrative_book_spec',
    'release_narrative_book_spec_v3',
    'write_manuscript',
    'compile_visual_storyboard'
  ));
