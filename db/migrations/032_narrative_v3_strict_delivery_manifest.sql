...
ALTER TABLE narrative_artifacts
  ...
  CHECK (artifact_type IN (
    ...
    'character_state_timeline', 'story_concept', 'canonical_story_graph',
    'object_lifecycle_projection', 'narrative_book_spec',
    'narrative_book_spec_v3', 'manuscript', 'manuscript_fact_evidence',
...
ALTER TABLE narrative_v3_steps
  ...
  CHECK (step_type IN (
    ...
    'compile_manuscript_fact_evidence', 'compile_visual_storyboard',
    'compile_visual_continuity_plan', 'record_image_candidates',
    'decide_illustrations', 'decide_illustrations_strict',
    'assemble_delivery_manifest', 'assemble_delivery_manifest_v2'
  ));
