...
<section class="formats" id="formats">
    <div class="shell formats-inner">
        <div class="formats-copy"><span class="eyebrow"><?php esc_html_e('Votre histoire reste disponible', 'calitiki'); ?></span><h2><?php esc_html_e('À lire sur écran, à écouter ou bientôt à garder en album', 'calitiki'); ?></h2><p><?php esc_html_e('Vous ne payez le livre qu’après avoir découvert l’aperçu. Toutes vos créations et leurs décisions importantes restent accessibles depuis Mes créations Calitiki.', 'calitiki'); ?></p><a class="text-link" href="<?php echo esc_url(calitiki_creations_url()); ?>"><?php esc_html_e('Ouvrir Mes créations Calitiki', 'calitiki'); ?> →</a></div>
        <a class="format-card" href="<?php echo esc_url(calitiki_product_url('ebook')); ?>" aria-label="<?php esc_attr_e('Découvrir le pack numérique personnalisé', 'calitiki'); ?>"><span class="format-icon">⌁</span><div><span class="format-status format-status-digital"><?php esc_html_e('Deux expériences incluses', 'calitiki'); ?></span><h3><?php esc_html_e('Pack numérique', 'calitiki'); ?></h3><p><?php esc_html_e('Recevez le PDF et retrouvez le livre interactif à lire sur mobile, tablette ou ordinateur.', 'calitiki'); ?></p><strong><?php esc_html_e('À partir de 6,69 € · Découvrir', 'calitiki'); ?> <span aria-hidden="true">→</span></strong></div></a>
