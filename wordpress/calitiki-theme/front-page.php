...
<section class="formats" id="formats">
    <div class="shell formats-inner">
        ...
        <a class="format-card" href="<?php echo esc_url(calitiki_product_url('ebook')); ?>" aria-label="<?php esc_attr_e('Découvrir le livre personnalisé en eBook', 'calitiki'); ?>"><span class="format-icon">⌁</span><div><h3><?php esc_html_e('eBook', 'calitiki'); ?></h3><p><?php esc_html_e('Version numérique prête à télécharger après paiement et envoyée par e-mail.', 'calitiki'); ?></p><strong><?php esc_html_e('À partir de 6,69 € · Découvrir', 'calitiki'); ?> <span aria-hidden="true">→</span></strong></div></a>
        <a class="format-card format-card-featured" href="<?php echo esc_url(calitiki_product_url('print')); ?>" aria-label="<?php esc_attr_e('Découvrir le livre personnalisé imprimé', 'calitiki'); ?>"><span class="format-icon">▣</span><div><h3><?php esc_html_e('Album imprimé', 'calitiki'); ?></h3><p><?php esc_html_e('Un véritable livre carré de 21 × 21 cm, avec délai de fabrication annoncé avant paiement.', 'calitiki'); ?></p><strong><?php esc_html_e('À partir de 29,90 € · Découvrir', 'calitiki'); ?> <span aria-hidden="true">→</span></strong></div></a>
    </div>
</section>
