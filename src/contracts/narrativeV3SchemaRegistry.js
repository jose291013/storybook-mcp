...
export const journeyLifecycleSchema = readSchema("journeyLifecycle.v1.schema.json");
...
ajv.addSchema(journeyLifecycleSchema);
...
const validators = new Map([
  ...
  ["journey_lifecycle", ajv.getSchema(journeyLifecycleSchema.$id)],
