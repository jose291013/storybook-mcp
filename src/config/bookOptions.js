...
export const UNIVERSE_OPTIONS = [
  {
    ...
    storyContract: {
      ...
      physicalTopology: {
        version: 1,
        originZone: "the established ordinary-world origin",
        adventureZone: "the established enchanted forest",
        transitionZone: "the one established forest threshold",
        originMedium: "breathable_air",
        adventureMedium: "breathable_air",
        transitionMedium: "forest_threshold",
        entryBoundary: "first_cross_passage",
        noBoundarySide: "adventure",
      },
      requiredMechanisms: [],
  ...
  },
  {
    ...
    storyContract: {
      ...
      physicalTopology: {
        version: 1,
        originZone: "the established breathable departure place",
        adventureZone: "the established protected spacecraft or cosmic habitat",
        transitionZone: "the one established sealed boarding boundary or portal",
        originMedium: "breathable_air",
        adventureMedium: "protected_breathable_space_environment",
        transitionMedium: "sealed_space_boundary",
        entryBoundary: "first_cross_passage",
        noBoundarySide: "adventure",
      },
      requiredMechanisms: [
  ...
  },
  {
    ...
    storyContract: {
      ...
      physicalTopology: {
        version: 1,
        originZone: "the established dry breathable origin",
        adventureZone: "the fully underwater coral ocean",
        transitionZone: "the one established water passage boundary",
        originMedium: "breathable_air",
  ...
  },
  {
    ...
    storyContract: {
      ...
      physicalTopology: {
        version: 1,
        originZone: "the established ground-level or indoor origin",
        adventureZone: "the established protected sky kingdom",
        transitionZone: "the one established protected sky route",
        originMedium: "breathable_air",
        adventureMedium: "protected_sky_environment",
        transitionMedium: "protected_sky_boundary",
        entryBoundary: "first_cross_passage",
        noBoundarySide: "adventure",
      },
      requiredMechanisms: [
  ...
  },
  {
    ...
    storyContract: {
      ...
      physicalTopology: {
        version: 1,
        originZone: "the established ordinary-world origin",
        adventureZone: "the established prehistoric valley",
        transitionZone: "the one established prehistoric passage boundary",
        originMedium: "breathable_air",
        adventureMedium: "breathable_air",
        transitionMedium: "prehistoric_threshold",
        entryBoundary: "first_cross_passage",
        noBoundarySide: "adventure",
      },
      requiredMechanisms: [],
  ...
  },
  {
    ...
    storyContract: {
      ...
      physicalTopology: {
        version: 1,
        originZone: "the established familiar district or home",
        adventureZone: "the established wonderful-city adventure districts",
        transitionZone: "the one established secret-passage boundary",
        originMedium: "breathable_air",
        adventureMedium: "breathable_air",
        transitionMedium: "city_passage_threshold",
        entryBoundary: "first_cross_passage",
        noBoundarySide: "adventure",
      },
      requiredMechanisms: [],
